...
$sql = "insert into teacher(name,email,cell,mid,dept,gender,password,path,role,status) values('$Name','$Email','$Cell','$Mid','$Dept','$Gender','$Pass','$actualpath','$Status','$CStatus')";

$result = mysqli_query($con,"SELECT cell FROM teacher where cell = '$Cell'");
$result1 = mysqli_query($con,"SELECT mid FROM teacher where mid = '$Mid'");
